...
public abstract class BaseActivity extends AppCompatActivity implements MenuItem.OnMenuItemClickListener {
    ...
    private NavigationView navigation_view; // The new navigation view from Android Design Library. Can inflate right_menu resources. Easy
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if((actionBar = getSupportActionBar())!= null){
            ...
            actionBar.setIcon(R.drawable.toolbar_logo);
        }else{
    ...
    public boolean onMenuItemClick(MenuItem item) {
        ...
        if (id == R.id.nav_center) {
            // create new activity
            Intent intent = new Intent(this, SearchCenterActivity.class);
            startActivity(intent);
        } else if (id == R.id.nav_forum) {
            Intent intent = new Intent(this, ForumLoginActivity.class);
            startActivity(intent);
            ...
            startActivity(intent);
        }else if(id == R.id.part_facebook){
            SharedPreferences settings = getSharedPreferences("UserInfo", 0);
            System.out.println(settings.getString("isFacebookLogged", "false"));
            if(settings.getString("isFacebookLogged", "false").equals("true")){
                startActivity(new Intent(this, ShareFacebookActivity.class));
            }else{
                Toast.makeText(this, "cannot start activity, did you login to facebook ?", Toast.LENGTH_LONG).show();
            }
